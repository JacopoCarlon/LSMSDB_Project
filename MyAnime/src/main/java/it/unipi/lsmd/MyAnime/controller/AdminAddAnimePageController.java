...
@Controller
public class AdminAddAnimePageController {

    @RequestMapping(value={"/adminAddAnime.html","/adminAddAnimePage.html","/adminAddAnime","/adminAddAnimePage"})
